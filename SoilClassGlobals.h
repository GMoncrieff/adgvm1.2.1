#ifndef SoilClassGlobals_h___
#define SoilClassGlobals_h___
...
// double const YASSO_A_CWL     = 0.03/365.;    // exposure of coarse woody litter to microbial decomposition
...
// double const YASSO_K_EXT     = 0.48/365.;    // decomposition rate of ext
