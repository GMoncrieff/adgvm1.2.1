...
// /* 27 */        yearly_output_data[26] = total_basal_area/(years_to_run-100.);  // basal area mean after spin-up
...
/* 38 */        yearly_output_data[47] = d_params[10];
/* 39 */        yearly_output_data[48] = d_params[11];
/* 40 */        yearly_output_data[49] = d_params[12];
/* 41 */        yearly_output_data[50] = d_params[13];
/* 42 */        yearly_output_data[51] = d_params[14];
/* 43 */        yearly_output_data[52] = d_params[15];
/* 44 */        yearly_output_data[53] = d_params[16];
/* 45 */        yearly_output_data[54] = d_params[17];
/* 46 */        yearly_output_data[55] = d_params[18];
/* 47 */        yearly_output_data[56] = d_params[19];
/* 45 */        yearly_output_data[57] = d_params[20];
/* 46 */        yearly_output_data[58] = d_params[21];
/* 47 */        yearly_output_data[59] = d_params[22];
/* 45 */        yearly_output_data[60] = d_params[23];
/* 46 */        yearly_output_data[61] = d_params[24];
/* 47 */        yearly_output_data[62] = d_params[25];
/* 45 */        yearly_output_data[63] = d_params[26];
/* 46 */        yearly_output_data[64] = d_params[27];
/* 47 */        yearly_output_data[65] = d_params[28];
/* 48 */        yearly_output_data[66] = MyTreePop.getActiveDays();
/* 49 */        yearly_output_data[67] = MyGrassPop.getActiveDays();
/* 50 */        yearly_output_data[68] = evapo_ref_sum;
/* 51 */        yearly_output_data[69] = A0C3_mean;
/* 52 */        yearly_output_data[70] = A0C4_mean;
