...
// double FQsumShade( double LAIupper, double LAIlower )
// {
// 	return (exp(-K_CAN_EXT*LAIlower)-exp(-K_CAN_EXT*LAIupper))*K_CAN_EXT_INVERSE;
// }
...
// double FQsumShadeBigPlant( double LAIbig, double LAIsmall )
// {
// 	return FQsumShade( LAIbig-LAIsmall, 0. ) +0.5*FQsumShade( LAIbig, LAIbig-LAIsmall );
// }
...
// double FQsumShadeSmallPlant( double LAIbig, double LAIsmall )
// {
// 	return 0.5*FQsumShade( LAIbig, LAIbig-LAIsmall );
// }
...
// double FQi( double LAIcomp, double LAItarget )
// {
// 	return MyMin(1.,exp(-K_CAN_EXT*(LAIcomp-LAItarget)));
// }
...
// double E25h( double Lai )
// {
// 	return E25H_CONST_1*pow( Lai, E25H_CONST_2 );
// }
...
// // 		ret = MyMax(0.,m*(A-resp)*(GetRatio(hs))*P/cs+b*LAI);	//ie for negative An we produce zero gs
// 		ret = m*(A-resp)*(GetRatio(hs))*P/cs+b*LAI;	//ie for negative An we produce zero gs
// 	}
// 	else
// 		ret = b*LAI;
// 	
