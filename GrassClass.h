#ifndef GrassClass_h___
#define GrassClass_h___
...
class clGrass
{
	...
	public:
		...
		double getFuelMoisture()	{ return fuel_moisture_; }
...
double clGrass::AllocStem()                                         // NOTE: not needed for grasses
{
	return 0;
}
...
#	ifdef GRAZING
	Bl_ *= grazing_rate;
	A_factor_ *= grazing_rate*0.01+0.99;
#	endif
...
double clGrass::getEt( double T, double P, double radnet_day, double s12, double SP_HEAT,
					   double gama12, double rho12, double VPD12 )
{
