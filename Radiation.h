#ifndef Radiation_h___
#define Radiation_h___
					   ...
					   int day, double *Rn, double *SunHrs)
{
	...
	*SunHrs	= psunshine*hrs;
	...
	Rns    	= FOARns(Rs);
// 	cout << "-------------" << setw(14) << Rs << setw(14) << Rso << setw(14) << Rnl << setw(14) << Rns << setw(14) << Rns-Rnl << endl;
...
// 	cout << "AAAA" << setw(14) << Rs << setw(14) << 5.*Rs*1e6 << setw(14) << sunhrs << setw(14) << 5.*Rs*1e6/(sunhrs*3600.) << endl;
