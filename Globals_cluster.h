...
const string IN_DATA_HOME				= "/home/gmoncrieff/InputData/";
...
// const double CA_PAR_PREASSURE			= 55.0;		// Atmospheric partial pressure C02
#endif
...
const double M_TREE[2]                  = { 9.0, 9.0 };     // ball berry constant dimensionless

// const double B_GRASS[6]                 = { 0.04, 0.04, 0.04, 0.01, 0.01, 0.01 }; // ball berry constant conductance units
// const double M_GRASS[6]                 = { 4.0, 4.0, 4.0, 9.0, 9.0, 9.0 }; // ball berry constant dimensionless
const double B_GRASS[6]                 = { 0.04, 0.04, 0.04, 0.04, 0.04, 0.04 }; // ball berry constant conductance units
const double M_GRASS[6]                 = { 4.0, 4.0, 4.0, 4.0, 4.0, 4.0 }; // ball berry constant dimensionless
...
const double K_CAN_EXT_GRASS_INVERSE[6] = { 1./K_CAN_EXT_GRASS[0], 1./K_CAN_EXT_GRASS[1], 1./K_CAN_EXT_GRASS[2], 
...
const double SIGMA_GROW_RESP_GRASS[6]   = { 0.35, 0.35, 0.35, 0.35, 0.35, 0.35 }; // growth respiration constant (Arora =0.35)            // NEW
#endif
...
const double OMEGA_LEAF_TREE[2]			= { EXTINC_FAC_TREE*pow(10.*SLA_TREE[0],EXTINC_EXP_TREE),
                                            EXTINC_FAC_TREE*pow(10.*SLA_TREE[1],EXTINC_EXP_TREE)};  // factor 10 to transform units
...
const double OMEGA_LEAF_GRASS[6]		= { EXTINC_FAC_GRASS*pow(10.*SLA_GRASS[0],EXTINC_EXP_GRASS),
...
const double HELPER_BLS_GRASS[6]		= {    1./OMEGA_LEAF_GRASS[0],    1./OMEGA_LEAF_GRASS[1],    1./OMEGA_LEAF_GRASS[2],
                                               1./OMEGA_LEAF_GRASS[3],    1./OMEGA_LEAF_GRASS[4],    1./OMEGA_LEAF_GRASS[5] };	// for turnover
const double HELPER_BL__GRASS[6]		= { 1.-1./OMEGA_LEAF_GRASS[0], 1.-1./OMEGA_LEAF_GRASS[1], 1.-1./OMEGA_LEAF_GRASS[2],
                                            1.-1./OMEGA_LEAF_GRASS[3], 1.-1./OMEGA_LEAF_GRASS[4], 1.-1./OMEGA_LEAF_GRASS[5] };	// for turnover
...
const double WATER_IND_GRASS_1[6]       = { 1.-WATER_IND_GRASS[0], 1.-WATER_IND_GRASS[1], 1.-WATER_IND_GRASS[2], 
...
#ifndef OPTIM_GLOBALS
const double LIGHT_COMP_SAVSAV = 0.5;
const double LIGHT_COMP_SAVC4 = 0.5;
const double LIGHT_COMP_SAVC3 = 0.15;
const double LIGHT_COMP_FORSAV = 0.5;
...
L_SAV_SAV, L_SAV_FOR, L_SAV_C4G, L_SAV_C4G, L_SAV_C4G, L_SAV_C3G, L_SAV_C3G, L_SAV_C3G,
L_FOR_SAV, L_FOR_FOR, L_FOR_C4G, L_FOR_C4G, L_FOR_C4G, L_FOR_C3G, L_FOR_C3G, L_FOR_C3G,
L_C4G_SAV, L_C4G_FOR, L_C4G_C4G, L_C4G_C4G, L_C4G_C4G, L_C4G_C3G, L_C4G_C3G, L_C4G_C3G,
L_C4G_SAV, L_C4G_FOR, L_C4G_C4G, L_C4G_C4G, L_C4G_C4G, L_C4G_C3G, L_C4G_C3G, L_C4G_C3G,
L_C4G_SAV, L_C4G_FOR, L_C4G_C4G, L_C4G_C4G, L_C4G_C4G, L_C4G_C3G, L_C4G_C3G, L_C4G_C3G,
L_C3G_SAV, L_C3G_FOR, L_C3G_C4G, L_C3G_C4G, L_C3G_C4G, L_C3G_C3G, L_C3G_C3G, L_C3G_C3G,
L_C3G_SAV, L_C3G_FOR, L_C3G_C4G, L_C3G_C4G, L_C3G_C4G, L_C3G_C3G, L_C3G_C3G, L_C3G_C3G,
L_C3G_SAV, L_C3G_FOR, L_C3G_C4G, L_C3G_C4G, L_C3G_C4G, L_C3G_C3G, L_C3G_C3G, L_C3G_C3G };

const double LICMP_2[8][8] = { 
1.-L_SAV_SAV, 1.-L_SAV_FOR, 1.-L_SAV_C4G, 1.-L_SAV_C4G, 1.-L_SAV_C4G, 1.-L_SAV_C3G, 1.-L_SAV_C3G, 1.-L_SAV_C3G,
1.-L_FOR_SAV, 1.-L_FOR_FOR, 1.-L_FOR_C4G, 1.-L_FOR_C4G, 1.-L_FOR_C4G, 1.-L_FOR_C3G, 1.-L_FOR_C3G, 1.-L_FOR_C3G,
1.-L_C4G_SAV, 1.-L_C4G_FOR, 1.-L_C4G_C4G, 1.-L_C4G_C4G, 1.-L_C4G_C4G, 1.-L_C4G_C3G, 1.-L_C4G_C3G, 1.-L_C4G_C3G,
1.-L_C4G_SAV, 1.-L_C4G_FOR, 1.-L_C4G_C4G, 1.-L_C4G_C4G, 1.-L_C4G_C4G, 1.-L_C4G_C3G, 1.-L_C4G_C3G, 1.-L_C4G_C3G,
1.-L_C4G_SAV, 1.-L_C4G_FOR, 1.-L_C4G_C4G, 1.-L_C4G_C4G, 1.-L_C4G_C4G, 1.-L_C4G_C3G, 1.-L_C4G_C3G, 1.-L_C4G_C3G,
1.-L_C3G_SAV, 1.-L_C3G_FOR, 1.-L_C3G_C4G, 1.-L_C3G_C4G, 1.-L_C3G_C4G, 1.-L_C3G_C3G, 1.-L_C3G_C3G, 1.-L_C3G_C3G,
1.-L_C3G_SAV, 1.-L_C3G_FOR, 1.-L_C3G_C4G, 1.-L_C3G_C4G, 1.-L_C3G_C4G, 1.-L_C3G_C3G, 1.-L_C3G_C3G, 1.-L_C3G_C3G,
1.-L_C3G_SAV, 1.-L_C3G_FOR, 1.-L_C3G_C4G, 1.-L_C3G_C4G, 1.-L_C3G_C4G, 1.-L_C3G_C3G, 1.-L_C3G_C3G, 1.-L_C3G_C3G };
#endif
// end constants for light competition model
...
const int YEARLY_DATA_LENGTH = 71;

const int INPUT_PARAMS = 29;
